...
client.on('guildCreate', guild => {
    ...
    asreaper1.send("**Axiom Botunu Sunucuya Eklediğiniz İçin Teşekkürler!** \n a?yardım Yazarak Yardım Menüsüne Erişebilirsiniz!");

});
client.on("guildCreate", async guild => {
  const asreaper2 = [
    "Botumuzu Sunucuna Eklediğin İçin Teşekkürler!",
    "Bu Bot Mehmet Duran Tarafından Geliştirilmiştir!",
    'a?yardım Yazarak Yardım Menüsüne Ulaşabilirsin'
  ];
