...
let maximusboys = new Discord.MessageEmbed()
...
return message.channel.send(maximusboys).then(m => m.delete(5000));
...
return channel.send(maximusboys).then(m => m.delete(5000));
